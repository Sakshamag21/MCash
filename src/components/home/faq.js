  ...
  return(
    <div id="faq" className="block faqBlock">
      <div className="container-fluid">
        ...
        <Collapse defaultActiveKey={['1']} style={{backgroundColor:"#ce93d8",borderColor:"transparent"}}>
          <Panel header="How to setup the theme?" key="1" style={{borderColor:"transparent"}} >
          ...
          <Panel header="Can I change plan or cancel at any time?" key="2" style={{borderColor:"transparent"}}>
          ...
          <Panel header="How to access through cloud?" key="3" style={{borderColor:"transparent"}}>
          ...
          <Panel header="Can I manage multiple task?" key="4" style={{borderColor:"transparent"}}>
          ...
          <Panel header="How can I change my password?" key="5" style={{borderColor:"transparent"}}>
          ...
          <Panel header="How to manage my account?" key="6" style={{borderColor:"transparent"}}>
